...
from mani_skill2_real2sim import ASSET_DIR, PACKAGE_ASSET_DIR
...
def initialize_sources():
    DATA_SOURCES["ycb"] = dict(
        url="https://storage1.ucsd.edu/datasets/ManiSkill2022-assets/mani_skill2_real2sim_ycb_v2.zip",
        target_path="mani_skill2_real2sim_ycb",
    ...
    DATA_SOURCES["egad"] = dict(
        url="https://storage1.ucsd.edu/datasets/ManiSkill2022-assets/mani_skill2_real2sim_egad_v1.zip",
        target_path="mani_skill2_real2sim_egad",
